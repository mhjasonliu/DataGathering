...
public class GravityManager extends DataManager{
    public GravityManager(String sName, SQLiteOpenHelper db, Context context) {
...
//
//        try {
//            sensId = getSensorId(T_GRAV, devId, database);
//        } catch (Resources.NotFoundException e) {
...
//            values.put(DataStorageContract.SensorTable.COLUMN_NAME_TYPE, T_GRAV);
//
//            database.insert(
